...
@SpireInitializer
public class LooterMod implements EditCharactersSubscriber, EditCardsSubscriber, PostInitializeSubscriber {
    ...
    public void receiveEditCharacters() {
        BaseMod.addCharacter(Looter.class, "Chaotician", "chaotician", CardColorEnum.GRAY.toString(),
                "Chaotician", null, null, PlayerClassEnum.CHAOTICIAN.toString());
    }
    ...
    public void receivePostInitialize() {
        ...
        // Mod badge
        Texture badgeTexture = new Texture("img/LooterModBadge.png");
